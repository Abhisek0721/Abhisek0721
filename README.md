...
<div align="left">
  <img align="center" src="https://skillicons.dev/icons?i=html,css,js,ts,py,nodejs,expressjs,nestjs,ts,jest,react,mongodb,mysql,postgres,redis,tailwindcss,bootstrap,django,flask,fastapi,aws,go,gin,linux,docker,git,c,cpp,java,kotlin" />
</div>
